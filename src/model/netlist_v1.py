...
def resistor_stamp(
    ...
    G = jax.lax.cond(elem_type == element_type_map["R"], update_G, lambda G: G, G)
    return G, C
...
def capacitor_stamp(
    ...
    C = jax.lax.cond(elem_type == element_type_map["C"], update_C, lambda C: C, C)
    return G, C
...
def module_test():
    print("Module test for netlist_v1.py")
